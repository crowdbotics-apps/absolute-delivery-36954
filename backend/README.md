...
## Project Structure
    ...
    ├── absolute_delivery_36954  # Django project configurations
...
1. Clone this repo and `cd absolute_delivery_36954`
...
2. Clone this repo and `cd absolute_delivery_36954`
